    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: t.bg }}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        ...
        >
          ...
          {/* Due date */}
          <Text style={[styles.sectionLabel, { color: t.textSecondary }]}>Due Date (optional)</Text>
          <TouchableOpacity
            style={[styles.dateBtn, { backgroundColor: t.surface2, borderColor: dueDate ? t.accent : t.border }]}
            onPress={() => setShowPicker(true)}
          >
            <Text style={{ fontSize: 14, color: dueDate ? t.textPrimary : t.textTertiary }}>
              {dueDate
          ...
          {errors.dueDate ? (
            <Text style={{ color: '#EF4444', fontSize: 11, marginTop: -12, marginBottom: 12 }}>
              {errors.dueDate}
            </Text>
          ) : null}
...
const styles = StyleSheet.create({
  ...
  chip:         { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 100 },
  dot:          { width: 7, height: 7, borderRadius: 3.5 },
  dateBtn:      { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 13, borderRadius: 12, borderWidth: 1.5, marginBottom: 16 },
});
