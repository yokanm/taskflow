  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: t.bg }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 20, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
            ...
            return (
              ...
              >
                <View style={[
                  ...
                  active && { borderWidth: 3, borderColor: s.color, shadowColor: s.color, shadowOpacity: 0.4, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 6 },
                ]}>
                  {active ? <Text style={{ color: 'white', fontSize: 18, fontWeight: '700' }}>✓</Text> : null}
                </View>
                <Text style={{ fontSize: 11, color: t.textSecondary, marginTop: 6, textAlign: 'center' }}>
                  {s.label}
                </Text>
              </TouchableOpacity>
            );
        ...
        {/* Live preview */}
        <Text style={[styles.sectionTitle, { color: t.textTertiary, marginTop: 28 }]}>Preview</Text>
...
const styles = StyleSheet.create({
  header:       { paddingHorizontal: 20, paddingTop: 10, paddingBottom: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1 },
  backBtn:      { width: 36, height: 36, borderRadius: 10, borderWidth: 1, alignItems: 'center', justifyContent: 'center' },
  sectionTitle: { fontSize: 11, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.7, marginBottom: 12 },
  modeCard:     { flex: 1, padding: 18, borderRadius: 16, alignItems: 'center', position: 'relative' },
  ...
  previewTask:  { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 10, borderRadius: 10, borderWidth: 1 },
  previewCb:    { width: 20, height: 20, borderRadius: 6, alignItems: 'center', justifyContent: 'center' },
